...
![Distribution Analysis](/assets/img/projects/malaysia-population/figure3-4-distribution.png)
...
![ARIMA Residuals](/assets/img/projects/malaysia-population/table5-residuals-arima.png)
*Log ARIMA(0,2,0) residual diagnostics: Normal Q-Q plot, histogram, and ACF showing good model fit*

![Additional Residual Plots](/assets/img/projects/malaysia-population/residuals-additional.png)
...
![Forecast Visualizations](/assets/img/projects/malaysia-population/figure5-forecast-plots.png)
*Figure 5: (a) Holt's Linear Trend Method forecast, (b) ARIMA(0,2,0) forecast with 95% confidence intervals*
